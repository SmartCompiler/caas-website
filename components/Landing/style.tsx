...
export const LandingWrapper = styled.section`
    background: linear-gradient(360deg, #010A09 0%, rgba(1, 7, 7, 0.92) 4.98%, rgba(1, 7, 7, 0.19) 13.83%, rgba(33, 41, 40, 0.04) 25.46%, rgba(255, 255, 255, 0) 106.25%), url(/landing.svg);    background-repeat: no-repeat;
